...
<td style="text-align: center; width: 5%;">&nbsp; </td>
 ...
 <p style="font-size: 14px; color: #353535; line-height: 20px;">This Agreement, (the “Agreement”), is made on the <span style="background-color: #fffc00;"><u >29 day of May, 2018</u>,</span> by and between Foremost Laboratories, LLC, a Michigan limited liability company, the address of 600 West Congress Street, Detroit, MI 48226, (Employer), and <span style="background-color: #fffc00;"><u >tom test</u></span> (Employee). The parties have negotiated certain terms of the Employee’s part-time employment with the Employer and have come to certain understandings about the terms and conditions of employment and wish to evidence this in writing.</p>
 <p style="font-size: 18px; color: #295b73; line-height: 20px;">RECITALS</p>
  <p style="font-size: 14px; color: #353535; line-height: 20px;">WHEREAS, Employer is engaged in the business of providing, directly or through affiliated entities, certain medical devices and medical device services to health care providers and facilities for the purpose of clinical testing of ANS/autonomic nervous system, and; 
<br/><br/>
WHEREAS, Employer desires to expand its business by informing and educating members of the medical community, and other interested parties about, among other things, the benefits of the clinical ANS services which the Employer can provide to individuals in need of such services, and Employer desires to hire Employee, on a part-time basis, to assist Employer in this endeavor, and; 
<br/><br/>
...
<p style="font-size: 14px; color: #353535; line-height: 20px;">Beginning with the Effective Date of this Agreement, the Employee shall receive compensation as described in Exhibit "A" attached hereto which shall be paid by Employer in accordance with the Employer’s regular payroll practices and procedures and Employee shall receive an IRS Form W-2 from Employer to reflect compensation paid under this Agreement.</p>
...
<p style="font-size: 14px; color: #353535; line-height: 20px;">Nexus Laboratory Management Systems, LLC</p>

<p style="font-size: 14px; color: #353535;  line-height: 20px;">By: /s/</p>';

 $html2='<table style="font-size:36px; color: #353535;  border-bottom: solid 1px #4b4b4b; width: 260px;"><tr><td>Sign Here</td></tr></table> ';
$html3='
<p style="font-size: 14px; color: #353535;">Christopher A. Parris<br/>Its: Senior Vice President</p>';

$html4='<div style="width: 1px;  border-left: dotted 1px #d5d6d6;"><br/><br/><br/><br/><br/><br/><br/><br/></div>';
...
$html6='<table style="font-size:36px; color: #353535;  border-bottom: solid 1px #4b4b4b; width: 260px;"><tr><td>Sign Here</td></tr></table> ';
...
<td style="width: 50px;"><p style="font-size: 14px; line-height: 20px; color: #353535;">CGX:</p></td>
<td style=" border-bottom: solid 1px #4b4b4b; width: 160px;">$10</td>
